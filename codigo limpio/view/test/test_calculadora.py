...
class TestCalculadoraLiquidacion(unittest.TestCase):
    ...
    def test_calculo_retencion(self):
        ...
        self.assertEqual(result, 1930612.50)  
    ...
    def test_calculo_indemnizacion_anios_completos(self):
        salario = 2000000
        tiempo_trabajado_anos = 1
        valor_indemnizacion = self.calculadora.calcular_indemnizacion(salario, tiempo_trabajado_anos)
        valor_esperado = round(salario * 20 / 30, 2)
        self.assertEqual(valor_indemnizacion, valor_esperado)

    def test_calculo_vacaciones_dias(self):
        salario = 1200000
        dias_acumulados_vacaciones = 15
        result = self.calculadora.calcular_vacaciones(salario, dias_acumulados_vacaciones)
        self.assertAlmostEqual(result, 600000.00, places=2)

    def test_calculo_cesantias_dias(self):
        salario_mensual = 2500000
        dias_trabajados = 20
        result = self.calculadora.calcular_cesantias(salario_mensual, dias_trabajados)
        self.assertEqual(result, 1666666.67)

    def test_calculo_retencion_maxima(self):
        ingreso_laboral = 10000000
        result = self.calculadora.calcular_retencion(ingreso_laboral)
        self.assertEqual(result, 6261222.50)

    def test_calculo_intereses_cesantias_maximos(self):
        cesantias = 2000000
        vacaciones = 1000000
        result = self.calculadora.calcular_intereses_cesantias(cesantias, vacaciones)
        self.assertEqual(result, 360000.00)

    def test_calculo_prima_maxima(self):
        salario_mensual = 2500000
        dias_trabajados = 180
        result = self.calculadora.calcular_prima(salario_mensual, dias_trabajados)
        self.assertAlmostEqual(result, 2500000.00, places=2)
    ...
    def test_calculo_vacaciones_zero(self):
        salario = 1500000
        dias_acumulados_vacaciones = 0
        result = self.calculadora.calcular_vacaciones(salario, dias_acumulados_vacaciones)
        self.assertEqual(result, 0.00)

    def test_calculo_cesantias_zero(self):
        salario_mensual = 3000000
        dias_trabajados = 0
        result = self.calculadora.calcular_cesantias(salario_mensual, dias_trabajados)
        self.assertEqual(result, 0.00)

    def test_calculo_intereses_cesantias_zero(self):
        cesantias = 0
        vacaciones = 0
        result = self.calculadora.calcular_intereses_cesantias(cesantias, vacaciones)
        self.assertEqual(result, 0.00)

    def test_calculo_prima_zero(self):
        salario_mensual = 2500000
        dias_trabajados = 0
        result = self.calculadora.calcular_prima(salario_mensual, dias_trabajados)
        self.assertEqual(result, 0.00)
